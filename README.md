...
This R package is a planning tool, designed to be used alongside other tools and sources of information about health datasets for research. **It is still in demo form and has only been tested on a limited number of metadata files.** 
