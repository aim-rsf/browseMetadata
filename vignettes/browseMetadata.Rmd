...
```
The OUTPUT csv contains the categorisations you made. The LOG csv contains information about the session as a whole, including various metadata. These two csv files contain the same timestamp column. If you do not like the formatting of the OUTPUT csv, see the function [mapMetadata_convert_outputs.R](https://github.com/aim-rsf/browseMetadata/blob/main/R/mapMetadata_convert_outputs.R) for an alternative. 
