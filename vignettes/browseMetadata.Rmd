...
The json file contains information about the data asset (dataset), data class (table) and data element (variable). In the metadata catalogue:

- *Data asset* refers to *Dataset* (a collection of data, can contain multiple tables)
- *Data class* refers to *Table*
- *Data Element* refers to each *Variable* name within a table
