...
#'
#' Empty log output dataframe for browseMetadata.R to fill. \cr \cr
#'
#' \item \code{log_Output <- data.frame(
...
#'
#' @source The dataframe was manually created for the browseMetadata.R function
